...
<div style=" display:flex; position:absolute;width:475.2px; height:14.4px; top:91.2px; left:80px;font-size:14px; font-weight:bold;justify-content:center; align-items:center; " > Purchase Order</div>
<div style=" display:flex; position:absolute;width:475.2px; height:14.4px; top:108px; left:80px;font-size:14px; font-weight:normal;justify-content:center; align-items:flex-end;border-top:2px solid black;  " >  </div>

<div style=" display:flex; position:absolute;width:51px; height:14.4px; top:120px; left:80px;font-size:14px; font-weight:normal;justify-content:left; align-items:flex-end; " > PO#:</div>
<div style=" display:flex; position:absolute;width:18.6px; height:14.4px; top:120px; left:131px;font-size:14px; font-weight:normal;justify-content:left; align-items:flex-end; " > ${poData.purchaseorderid}</div>
<div style=" display:flex; position:absolute;width:74.4px; height:14.4px; top:120px; left:350.6px;font-size:14px; font-weight:normal;justify-content:flex-start; align-items:flex-end; " > PO Date:</div>
<div style=" display:flex; position:absolute;width:93px; height:14.4px; top:120px; left:443.6px;font-size:14px; font-weight:normal;justify-content:flex-start; align-items:flex-end; " > ${poData.date}</div>
<div style=" display:flex; position:absolute;width:51px; height:14.4px; top:148.8px; left:80px;font-size:14px; font-weight:normal;justify-content:left; align-items:flex-end; " > Customer:</div>
<div style=" display:flex; position:absolute;width:182.4px; height:14.4px; top:148.8px; left:149.6px;font-size:14px; font-weight:normal;justify-content:flex-start; align-items:flex-end; " > ${poData.customername}</div>
<div style=" display:flex; position:absolute;width:93px; height:14.4px; top:148.8px; left:350.6px;font-size:14px; font-weight:normal;justify-content:flex-start; align-items:flex-end; " > Customer PO #:</div>
...
<div style=" display:flex; position:absolute;width:201px; height:57.6px; top:192px; left:149.6px;font-size:14px; font-weight:normal;line-height: 1rem;justify-content:flex-start; align-items:flex-start; " > ${poData.address}</div>
...
<div style=" display:flex; position:absolute;width:182.4px; height:14.4px; top:285.4px; left:149.6px;font-size:14px; font-weight:normal;justify-content:flex-start; align-items:flex-end; " > ${poData.style}</div>
...
<div style=" display:flex; position:absolute;width:111.6px; height:14.4px; top:285.4px; left:443.6px;font-size:14px; font-weight:normal;justify-content:flex-start; align-items:flex-end; " > ${poData.customerstylename}</div>
<div style=" display:flex; position:absolute;width:69.6px; height:14.4px; top:307.2px; left:80px;font-size:14px; font-weight:normal;justify-content:flex-start; align-items:flex-end; " > Fabric:</div>
<div style=" display:flex; position:absolute;width:182.4px; height:14.4px; top:307.2px; left:149.6px;font-size:14px; font-weight:normal;justify-content:flex-start; align-items:flex-end; " > ${poData.fabricname}</div>
...
<div style=" display:flex; position:absolute;width:93px; height:14.4px; top:307.2px; left:443.6px;font-size:14px; font-weight:normal;justify-content:flex-start; align-items:flex-end; " > ${poData.colour}</div>
<div style=" display:flex; position:absolute;width:69.6px; height:14.4px; top:336px; left:80px;font-size:14px; font-weight:normal;justify-content:flex-start; align-items:flex-end; " > Ex-Fty:</div>
<div style=" display:flex; position:absolute;width:163.8px; height:14.4px; top:336px; left:149.6px;font-size:14px; font-weight:normal;justify-content:flex-start; align-items:flex-end; " > ${poData.exfactorydate}</div>
...
<div style=" display:flex; position:absolute;width:93px; height:14.4px; top:336px; left:443.6px;font-size:14px; font-weight:normal;justify-content:flex-start; align-items:flex-end; " > ${poData.department}</div>
<div style=" display:flex; position:absolute;width:69.6px; height:14.4px; top:364.8px; left:80px;font-size:14px; font-weight:normal;justify-content:flex-start; align-items:flex-end; " > Ship Mode:</div>
<div style=" display:flex; position:absolute;width:163.8px; height:14.4px; top:364.8px; left:149.6px;font-size:14px; font-weight:normal;justify-content:flex-start; align-items:flex-end; " > ${poData.shippingmode}</div>
...
<div style=" display:flex; position:absolute;width:93px; height:14.4px; top:364.8px; left:443.6px;font-size:14px; font-weight:normal;justify-content:flex-start; align-items:flex-end; " > ${poData.shippingmethod}</div>

<div style=" display:flex; position:absolute;width:475.2px; height:14.4px; top:387.6px; left:80px;font-size:14px; font-weight:normal;justify-content:center; align-items:flex-end;border-bottom:2px solid black;  " >  </div>
<div style=" display:flex; position:absolute;width:71px; height:14.4px; top:408px; left:80px;font-size:14px; font-weight:normal;justify-content:left; align-items:flex-end; " > Price ${poData.currency}: </div>
<div style=" display:flex; position:absolute;width:44.4px; height:14.4px; top:408px; left:141px;font-size:14px; font-weight:normal;justify-content:flex-start; align-items:flex-end; " > ${poData.supplierprice}</div>
...
<div style=" display:flex; position:absolute;width:55.8px; height:14.4px; top:408px; left:280.2px;font-size:14px; font-weight:normal;justify-content:flex-start; align-items:flex-end; " > ${poData.totalqty}</div>
<div style=" display:flex; position:absolute;width:103px; height:14.4px; top:408px; left:330.6px;font-size:14px; font-weight:normal;justify-content:flex-start; align-items:flex-end; " > Total Value ${poData.currency}:</div>
<div style=" display:flex; position:absolute;width:93px; height:14.4px; top:408px; left:450.6px;font-size:14px; font-weight:normal;justify-content:flex-start; align-items:flex-end; " > ${poData.totalvalue}</div>
<div style=" display:flex; position:absolute;width:456.6px; height:28.8px; top:436.8px; left:80px;font-size:14px; font-weight:normal;justify-content:flex-start; align-items:flex-start; " id="po-table1" ></div>

<div style=" display:flex; position:absolute;width:475.2px; height:14.4px; top:476.6px; left:80px;font-size:14px; font-weight:normal;justify-content:center; align-items:flex-end;border-bottom:2px solid black;  " >  </div>

<div style=" display:flex; position:absolute;width:51px; height:14.4px; top:494.4px; left:80px;font-size:14px; font-weight:normal;justify-content:left; align-items:flex-end; " > Rermarks:</div>
<div style=" display:flex; position:absolute;width:252px; height:14.4px; top:508.8px; left:80px;font-size:14px; font-weight:normal;justify-content:flex-start; align-items:flex-end; " > Please see how to pack as below</div>
<div style=" display:flex; position:absolute;width:456.6px; height:43.2px; top:530px; left:80px;font-size:14px; font-weight:normal;justify-content:flex-start; align-items:flex-start; " id="po-table2"> </div>

<div style=" display:flex; position:absolute;width:475.2px; height:14.4px; top:625.6px; left:80px;font-size:14px; font-weight:normal;justify-content:center; align-items:flex-end;border-bottom:2px solid black;  " >  </div>


<div style=" display:flex; position:absolute;width:79.6px; height:14.4px; top:645.4px; left:80px;font-size:14px; font-weight:normal;justify-content:flex-start; align-items:flex-end; " > Colour Code:</div>
...
// <div style=" display:flex; position:absolute;width:475.2px; height:14.4px; top:387.6px; left:80px;font-size:14px; font-weight:normal;justify-content:center; align-items:flex-end;border-bottom:2px solid black;  " >  </div>
// <div style=" display:flex; position:absolute;width:71px; height:14.4px; top:408px; left:80px;font-size:14px; font-weight:normal;justify-content:left; align-items:flex-end; " > Price USD:</div>
...
// <div style=" display:flex; position:absolute;width:456.6px; height:28.8px; top:436.8px; left:80px;font-size:14px; font-weight:normal;justify-content:flex-start; align-items:flex-start; " > ${sizeqty}</div>

// <div style=" display:flex; position:absolute;width:475.2px; height:14.4px; top:476.6px; left:80px;font-size:14px; font-weight:normal;justify-content:center; align-items:flex-end;border-bottom:2px solid black;  " >  </div>

// <div style=" display:flex; position:absolute;width:51px; height:14.4px; top:494.4px; left:80px;font-size:14px; font-weight:normal;justify-content:left; align-items:flex-end; " > Rermarks:</div>
// <div style=" display:flex; position:absolute;width:252px; height:14.4px; top:508.8px; left:80px;font-size:14px; font-weight:normal;justify-content:flex-start; align-items:flex-end; " > Please see how to pack as below</div>
// <div style=" display:flex; position:absolute;width:456.6px; height:43.2px; top:530px; left:80px;font-size:14px; font-weight:normal;justify-content:flex-start; align-items:flex-start; " > ${packingdetails}</div>
